...
ggplot(az_nat_65_overall, aes(x = year, y = mean_prev)) +
  ...
  labs(
    title = "National Cognitive Prevalence Among Adults 65+ (2015–2022)",
    x = "Year",
    y = "Mean Prevalence (%)",
...
1. **Temporal Stability**: National cognitive prevalence among adults 65+ remained stable at approximately 25–27% from 2015–2022, with no clear trend.
