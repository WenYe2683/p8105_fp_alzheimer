...
Track the **national average** cognitive prevalence from 2015 to 2016. Click on legend items to show/hide specific metrics.
...
The following visualizations use **linked brushing** – select points in one plot and see them highlighted across all plots. This helps identify states that may be outliers across multiple dimensions.
...
2. **Temporal Stability**: National average prevalence has remained relatively stable between 25-27% among adults aged 65+ from 2015-2016, with considerable between-state variation.
