...
output: 
  html_document:
    ...
    code_folding: hide
---
# Prevalence of Cognitive Decline by State/Territory, Age, and Sex
...
# Aggreted State/Territory-Level Household Income Statistics
Below is the aggregrated state/territory-level household income statistics from 2015 to 2016:
```{r message=FALSE}
#data import
