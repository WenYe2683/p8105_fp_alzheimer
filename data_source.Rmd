...
This page documents the data sources used in our analysis of cognitive decline and Alzheimer's-related indicators across the United States. 
...
We integrated 4 publicly available datasets to examine geographic, socioeconomic, and environmental factors associated with self-reported cognitive problems among middle-aged and older adults:
...
air_state_level |>
  ...
  kable(
    ...
    caption = "Table 5: Aggregated State/Territory-Level PM2.5 Concentrations",
    digits = 2,              
    align = "c"
  )
```
...
az_air |>
  ...
  kable(
    ...
    caption = "Table 6: Linked Dataset of Cognitive Decline and Air Quality (2015–2016)",
    digits = 2,    
    align = "c"   
  )
```
