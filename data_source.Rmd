...
az_cog_state_age_sex |>
  head(10) |>
  kable(
    col.names = c("State Abbr", "State", "Age Group", "Sex", "Obs Count", "Mean Prevalence (%)"),
    caption = "Table 2: Top 10 Mean Prevalence of Cognitive Decline by State, Age, and Sex",
    digits = 1,
    align = "c"
  )
```
...
top10_state_15_16 |>
  kable(
    col.names = c("Abbreviation", "Location", "Obs Count", "Mean Prevalence (%)"),
    caption = "Table 3: Top 10 Locations with Highest Cognitive Decline Prevalence (Age 65+, 2015–2016)",
    digits = 1,
    align = "c"
  )
```
...
income_state_level |>
  head(10) |>
  kable(
    col.names = c("Year", "State", "No. of Counties", "Median Income (usd)", "Average Income (usd)"),
    caption = "Table 4: Aggregated State-Level Household Income Statistics (2015)",
    digits = 0,           
    format.args = list(big.mark = ","),
    align = "c"
  )
